  ...
  application: {
    login_or_password_incorrect: {
      ...
      labels: [
        ...
        "Foydanuvchi logini yoki parol noto'g'ri!",
      ],
    },
    admin_not_found_by_login: {
      id: 10001,
      status: 'NOT FOUND',
      code: 'ADMIN',
      labels: [
        ...
        'Bunday logindagi admin topilmadi!',
      ],
    },
    product_not_found: {
      id: 10002,
    ...
    admin_not_found_by_id: {
      ...
      labels: [
        ...
        'Aдмин не найден по логину!',
        'Bunday ID dagi admin topilmadi!',
      ],
    },
    forbidden_admin: {
      id: 10009,
      ...
      code: 'ADMIN',
      labels: [
        'You do not have the authority to edit the login and password!',
        'Parolni tahrirlash huquqiga ega emassiz!',
      ],
    },
    old_password_incorrect: {
      ...
      labels: [
        ...
        "Foydanuvchining eski parol noto'g'ri!",
      ],
    },
    confirm_new_password_incorrect: {
      id: 10011,
      status: 'BAD REQUEST',
      code: 'ADMIN',
      labels: [
    ...
    already_exist_admin: {
      ...
      status: 'BAD REQUEST',
      code: 'ADMIN',
      labels: ['Already exist login!', 'Bu logindagi admin mavjud!'],
    },
    already_exist_admin_phone: {
      id: 10013,
      status: 'BAD REQUEST',
      code: 'ADMIN',
      labels: ['Already exist phone!', 'Bunday telefon raqam mavjud!'],
    },
    error_create_file: {
      id: 10014,
      status: 'INTERNAL SERVER ERROR',
      code: 'FILE',
      labels: ['Error creating file!', 'Faylni yozishda xatolik!'],
    },
    error_delete_file: {
      id: 10015,
      status: 'INTERNAL SERVER ERROR',
      code: 'FILE',
      labels: ['Error deleting file!', 'Faylni olib tashlashda xatolik!'],
    },
    logo_not_found: {
      id: 10016,
      status: 'NOT FOUND',
      code: 'LOGO',
      labels: [
        'Logo not found by ID!',
        'Ushbu IDga tegishli logotip topilmadi!',
      ],
    },
    image_validation: {
      id: 10016,
    ...
    already_exist_email: {
      ...
      status: 'BAD REQUEST',
      code: 'USER',
      labels: ['Already exist email!', 'Bunday email mavjud!'],
    },
    already_exist_phone: {
      id: 10019,
      status: 'BAD REQUEST',
    ...
    file_validation: {
      ...
      code: 'FILE',
      labels: [
        'Only PDF, DOC and XLS files are allowed!',
        'Faqat PDF, DOC va XLS fayllariga ruxsat beriladi!',
      ],
    },
  },
};
